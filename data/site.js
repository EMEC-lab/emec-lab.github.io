...
const SITE = {
   ...
   *
   * 목록(targets, qualify, support, highlights)은 항목을 늘리거나 줄여도
  ...
  join: {
    ...
    highlights: [
      "박사 · 석박사통합 · 석사과정, 학부연구생을 모집합니다",
      "등록금 전액 지원과 인건비를 지급합니다",
      "과제 · 논문 인센티브와 국내외 학술대회 참가를 지원합니다"
    ],
    ...
    qualify: [
      ...
      "석사과정 지원자는 학부연구생 1년 이상 수행을 권장"
    ],
    qualifyNote: "위 항목은 우대 사항일 뿐 필수 조건이 아닙니다. 전기기기를 처음 접하더라도 배우려는 마음이 있다면 지원해 주세요.",
    ...
    applyLabel: "지원 방법",
    howToApply: "관심 있는 연구분야를 적어 아래 메일로 보내주세요.",
    applyNote:  "연구실 합류 여부와 관계없이, 대학원 생활이나 연구 방향이 궁금하신 분들도 편하게 문의주세요.",
    ...
    cultureLabel: "연구실 생활",
    culture: "개인별 연구 내용은 1:1 미팅으로, 참여 중인 프로젝트는 팀 단위 미팅으로 논의합니다. 주제마다 주 1회 이상 만납니다."
  },
