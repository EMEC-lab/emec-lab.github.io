...
const SITE = {
  ...
  join: {
    ...
    researchLabel: "연구 내용",
    /* 학부생이 읽는 자리다. 전문 용어를 앞세우지 말고,
       무엇을 만드는지 → 무엇을 배우는지 순으로 둔다.
       자세한 내용은 아래 researchLink 가 연구분야 페이지로 보낸다 */
    researchNote: [
      "전기로 움직이는 기계, 그리고 움직임을 전기로 바꾸는 기계의 설계",
      {
        text: "무엇을 만드나",
        row: true,
        sub: [
          "전기차 · 에어택시 · 선박의 구동 모터",
          "로봇 관절과 가전의 모터, 발전기와 변압기"
        ]
      },
      {
        text: "무엇을 배우나",
        row: true,
        sub: [
          "자석과 코일이 만드는 힘을 컴퓨터로 계산 (전자기장 해석)",
          "모터가 뜨거워지고 떨리는 까닭을 예측 (열 · 진동 해석)",
          "성능 · 무게 · 효율을 함께 만족하는 형상 탐색 (최적설계 · AI)"
        ]
      },
      "학부 과목 중 전기기기 · 전자기학 · 회로이론이 바탕. 미리 잘할 필요는 없음"
    ],
