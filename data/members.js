...
const MEMBERS = [
  {
    ...
    talks: [
      { date: "2026-07-02", host: "한국자동차연구원", title: "로봇용 고토크밀도 모터의 제조 공차 분석 및 치수 최적화" },
  ...
  },
  {
    ...
    ], career: [], activities: [], memberships: [], talks: [], scholar: "", honors: "과학기술전문사관 장학생 (국방과학연구소, ADD)",
