...
#   클립 7 만 3.6초다. 팔을 보여주고 도시로 빠져나오는 두 가지를 해야 해서
#     3초로는 팔이 1.5초밖에 안 나온다
#   START+LEN 이 원본 길이(6.04초)를 넘지 않게 할 것
declare -A START=( [1]=0.0 [2]=2.1 [3]=1.5 [4]=0.9 [5]=0.8 [6]=1.3 [7]=1.8 )
declare -A LEN=(   [1]=2.0 [2]=3.0 [3]=3.0 [4]=3.0 [5]=3.0 [6]=3.0 [7]=3.6 )
